<template>
  ...
  <section class="container">
    <div class="btns">
      <div class="btn java">DataSure</div>
      <div class="btn golang">DataSure!</div>
      <div class="btn js"><span>DataSure</span></div>
      ...
      <div class="btn python python-1">CloudSure</div>
      <div class="btn python python-2">CloudSure</div>
      <div class="btn python python-3">CloudSure</div>
      <div class="btn python python-4">CloudSure</div>
      <div class="btn python python-5">CloudSure</div>

      <div class="btn php php-1">CloudSure</div>
      <div class="btn php php-2">CloudSure</div>
      <div class="btn php php-3">CloudSure</div>
      <div class="btn php php-4">CloudSure</div>
      <div class="btn php php-5">CloudSure</div>

      <div class="btn kotlin kotlin-3">CloudSure</div>
      <div class="btn kotlin kotlin-1">CloudSure</div>
      <div class="btn kotlin kotlin-4">CloudSure</div>
      <div class="btn kotlin kotlin-2">CloudSure</div>
      <div class="btn kotlin kotlin-5">CloudSure</div>
      <div class="btn c">CloudSure</div>
    </div>
  </section>
</template>
<script setup>
...
.kotlin-4:hover {
  ...
  background: linear-gradient(135deg, rgba(238, 161, 99, 0.25) 0.25em, transparent 0.25em) -0.5em
      0,
...
.kotlin-5:hover {
  ...
  background: radial-gradient(circle, rgba(249, 135, 155, 0.25) 43%, transparent 50%) 0 0/1em
      1em,
    radial-gradient(circle, rgba(249, 135, 155, 0.25) 43%, transparent 50%) 0.5em 0.5em/2em
      2em;
  color: #0bdcb7;
}
